...
function buildOfferLetterHTML(ol) {
  ...
  // ── HEADER HTML (separate file for wkhtmltopdf --header-html) ──────────────
  const headerHtml = `<!DOCTYPE html><html><head><meta charset="UTF-8">
<style>
* { margin:0; padding:0; box-sizing:border-box; }
body { font-family:'Times New Roman',Times,serif; font-size:12pt; }
.hdr { padding: 10px 18mm 0; }
.hdr-table { width:100%; border-collapse:collapse; }
.logo-td { width:96px; vertical-align:top; padding-right:10px; }
.logo-img { width:82px; height:82px; object-fit:contain; display:block; }
.tag { font-size:6pt; font-weight:bold; color:#333; line-height:1.3; margin-top:4px; text-align:center; width:82px; }
.name-td { vertical-align:top; }
.company { font-size:19pt; font-weight:bold; color:#000; line-height:1.2; margin-bottom:4px; }
.addr { font-size:9.5pt; color:#000; line-height:1.6; text-align:center; }
.rule { border-top:2px solid #000; margin:8px 18mm 0; }
</style></head><body>
<div class="hdr">
  <table class="hdr-table" cellpadding="0" cellspacing="0">
    <tr>
      <td class="logo-td">
        <img src="${LOGO}" class="logo-img" alt="KCMS">
        <div class="tag">BRINGING KRISHI AND<br>VIGYAN TOGETHER</div>
      </td>
      <td class="name-td">
        <div class="company">&nbsp;&nbsp;&nbsp;Krishi Care &amp; Management Services Private Limited</div>
        <div class="addr">
          <strong>Office Address:</strong> 617, 6th Floor, Hubtown Viva, Western Express Highway,
...
<div class="rule"></div>
  ...
  // ── FOOTER HTML (separate file for wkhtmltopdf --footer-html) ─────────────
  const footerHtml = `<!DOCTYPE html><html><head><meta charset="UTF-8">
<style>
* { margin:0; padding:0; box-sizing:border-box; }
body { font-family:'Times New Roman',Times,serif; font-size:9pt; }
.ftr { padding: 4px 18mm 8px; }
.rule { border-top:1px solid #000; margin-bottom:4px; }
.corp { text-align:center; line-height:1.7; }
.cin  { text-align:center; font-weight:bold; }
</style></head><body>
<div class="ftr">
  <div class="rule"></div>
  <p class="corp"><strong>Corporate Office:</strong> H-12, Green Park Extension, New Delhi -110016. Tel: 011-41039506.</p>
  <p class="cin">CIN: ${COMPANY.cin}</p>
</div>
</body></html>`;
...
.para  { font-size:12pt; line-height:1.65; text-align:justify; margin-bottom:10px; }
.sec   { font-size:12pt; font-weight:bold; text-decoration:underline; margin:14px 0 6px; page-break-after:avoid; }
.date-line { text-align:right; font-weight:bold; margin-bottom:16px; }
.cand  { margin-bottom:14px; line-height:1.65; }
.cand-name { font-weight:bold; }
.salut { margin:12px 0 10px; }
.subj  { font-weight:bold; text-align:center; text-decoration:underline; margin:10px 0 14px; }
ul.rules { margin:4px 0 10px 28px; }
ul.rules li { font-size:12pt; line-height:1.65; margin-bottom:8px; text-align:justify; page-break-inside:avoid; }
.sig-into { margin:14px 0 8px; line-height:1.7; }
.sig-row  { display:flex; justify-content:space-between; margin-top:40px; }
.sig-col  { width:46%; }
.sig-img  { height:46px; max-width:160px; object-fit:contain; display:block; margin-bottom:4px; }
.sig-blank{ height:46px; }
.sig-lbl  { font-weight:bold; }
.ann-title{ text-align:center; font-weight:bold; text-decoration:underline; margin:14px 0 12px; }
.ann-meta { font-weight:bold; line-height:1.9; margin-bottom:14px; }
.sal { width:100%; border-collapse:collapse; font-size:11pt; margin-bottom:18px; }
.sal td,.sal th { border:1px solid #999; padding:5px 8px; font-family:'Times New Roman',Times,serif; }
.r-gross-hd td { background:#ffff00!important; font-weight:bold; font-size:11.5pt; }
.r-col-hd   td { font-weight:bold; }
.r-total-gross td { font-weight:bold; }
.r-ded-row  td { background:#ffc7ce!important; color:#9c0006; }
.r-total-ded td { background:#ffc7ce!important; font-weight:bold; color:#9c0006; }
.r-net      td { background:#c6efce!important; font-weight:bold; color:#276221; }
.r-blank    td { background:#fff; border:none; }
.r-ctc-hd   td { font-weight:bold; border:none; padding-top:8px; }
.r-ctc-total td { background:#ffff00!important; font-weight:bold; }
.c-r { text-align:right; }
.ack-title { font-weight:bold; text-decoration:underline; margin:16px 0 8px; }
.ack-para  { line-height:1.6; margin-bottom:20px; }
.ack-row   { display:flex; justify-content:space-between; margin-bottom:18px; }
.ack-field { width:46%; }
.ack-line  { display:inline-block; border-bottom:1px solid #000; min-width:160px; }
@media print {
  body { margin:0; }
...
<div class="cand">
  ...
  ${ol.candidate_address ? `<p>${ol.candidate_address.replace(/\\n/g,'<br>')}</p>` : ''}
  <br>
  ...
  ${ol.candidate_email  ? `<p><strong>Email &ndash; ${ol.candidate_email}</strong></p>` : ''}
</div>
...
<p class="sec">SEPERATION OF SERVICES:</p>
...
${ol.custom_clauses ? `<p class="sec">ADDITIONAL TERMS:</p><p class="para">${ol.custom_clauses}</p>` : ''}
<p class="sec page-break">OTHER RULES AND REGULATION:</p>
...
<p class="sig-into">Yours truly,<br>From <strong>Krishi Care &amp; Management Services Private Limited,</strong></p>
<div class="sig-row">
  <div class="sig-col">
  ...
  <div class="sig-col">
    ...
    <p class="sig-lbl">Human Resource</p>
...
<table class="sal">
  <tr class="r-gross-hd"><td colspan="2"><strong>Gross salary per month</strong></td><td class="c-r" colspan="2"><strong>${fmtV(gross)}</strong></td></tr>
  <tr class="r-col-hd"><td colspan="2"><strong>Components In salary</strong></td><td class="c-r"><strong>Per month</strong></td><td class="c-r"><strong>Per annum</strong></td></tr>
  <tr><td colspan="2">Basic Salary</td><td class="c-r">${fmtV(basic)}</td><td class="c-r">${fmtV(basic*12)}</td></tr>
  <tr><td colspan="2">HRA (calculated on basic wage)</td><td class="c-r">${fmtV(hra)}</td><td class="c-r">${fmtV(hra*12)}</td></tr>
  <tr><td colspan="2">Conveyance allowances (Fixed)</td><td class="c-r">${conv>0?fmtV(conv):'-'}</td><td class="c-r">${conv>0?fmtV(conv*12):'0'}</td></tr>
  <tr><td colspan="2">Other allowances (Balance amount)</td><td class="c-r">${fmtV(other)}</td><td class="c-r">${fmtV(other*12)}</td></tr>
  <tr><td colspan="2">Gratuity</td><td class="c-r">${fmtV(gratuity)}</td><td class="c-r">${fmtV(gratuity*12)}</td></tr>
  <tr class="r-total-gross"><td colspan="2"><strong>Total Gross Salary</strong></td><td class="c-r"><strong>${fmtV(gross)}</strong></td><td class="c-r"><strong>${fmtV(gross*12)}</strong></td></tr>
  <tr class="r-ded-row"><td colspan="2">PF contribution by employee (on basic)</td><td class="c-r">${pfEmp>0?fmtV(pfEmp):'-'}</td><td class="c-r">${pfEmp>0?fmtV(pfEmp*12):'-'}</td></tr>
  <tr class="r-ded-row"><td colspan="2">ESI contribution by employee (on gross)</td><td class="c-r">-</td><td class="c-r">0</td></tr>
  <tr class="r-ded-row"><td colspan="2">Professional Tax (PT) (Different for each state)</td><td class="c-r">${pt>0?fmtV(pt):'-'}</td><td class="c-r">${pt>0?fmtV(pt*12):'-'}</td></tr>
  <tr class="r-total-ded"><td colspan="2"><strong>Total deductions (PF+ESI+PT)</strong></td><td class="c-r"><strong>${fmtV(totalDed)}</strong></td><td class="c-r"><strong>${fmtV(totalDed*12)}</strong></td></tr>
  <tr class="r-net"><td colspan="2"><strong>Net Salary (Gross-Total deductions)</strong></td><td class="c-r"><strong>${fmtV(netSalary)}</strong></td><td class="c-r"><strong>${fmtV(netSalary*12)}</strong></td></tr>
  <tr class="r-blank"><td colspan="4">&nbsp;</td></tr>
  <tr class="r-ctc-hd"><td colspan="4"><strong>CTC Calculation</strong></td></tr>
  <tr><td colspan="2">Employer PF contribution</td><td class="c-r">${pfEmpr>0?fmtV(pfEmpr):'-'}</td><td class="c-r">${pfEmpr>0?fmtV(pfEmpr*12):'0'}</td></tr>
  <tr><td colspan="2">Employer PF contribution Admin charges</td><td class="c-r">${pfAdmin>0?fmtV(pfAdmin):'-'}</td><td class="c-r">${pfAdmin>0?fmtV(pfAdmin*12):'0'}</td></tr>
  <tr><td colspan="2">Employer ESI contribution</td><td class="c-r">-</td><td class="c-r">0</td></tr>
  <tr class="r-ctc-total"><td colspan="2"><strong>CTC= Gross salary + (Employer PF+ ESI)</strong></td><td class="c-r"><strong>${fmtV(ctcMonthly)}</strong></td><td class="c-r"><strong>${fmtV(ctcAnnual)}</strong></td></tr>
</table>
...
<div class="ack-row">
  <div class="ack-field"><span>Signature: </span><span class="ack-line">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></div>
  <div class="ack-field"><span>Name: </span><span class="ack-line">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></div>
</div>
<div class="ack-row">
  <div class="ack-field"><span>Location: </span><span class="ack-line">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></div>
  <div class="ack-field"><span>Date </span><span class="ack-line">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></div>
</div>
</div>`;

  // Full HTML (for browser preview — shows header inline, no fixed footer needed)
  const fullHtml = `<!DOCTYPE html><html lang="en"><head>
<meta charset="UTF-8">
<title>Offer Letter &mdash; ${ol.candidate_name}</title>
<style>
${css}
/* SCREEN: show header inline per page block */
.page { width:210mm; min-height:297mm; margin:0 auto 28px; background:#fff; padding:0; display:flex; flex-direction:column; }
.page-hdr { padding:10px 20px 0; flex-shrink:0; }
.page-body { padding:14px 24px 10px; flex:1; }
.page-ftr { padding:0 20px 14px; margin-top:auto; flex-shrink:0; }
.page-ftr .ftr-rule { border-top:1px solid #000; margin-bottom:4px; }
.page-ftr .ftr-text { font-size:9pt; text-align:center; line-height:1.7; }
.page-ftr .ftr-cin  { font-size:9pt; text-align:center; font-weight:bold; }
.page-hdr .hdr-table { width:100%; border-collapse:collapse; }
.page-hdr .logo-td { width:96px; vertical-align:top; padding-right:10px; }
.page-hdr .logo-img { width:82px; height:82px; object-fit:contain; display:block; }
.page-hdr .tag { font-size:6pt; font-weight:bold; color:#333; line-height:1.3; margin-top:4px; text-align:center; width:82px; }
.page-hdr .company { font-size:19pt; font-weight:bold; line-height:1.2; margin-bottom:4px; }
.page-hdr .addr { font-size:9.5pt; line-height:1.6; text-align:center; }
.page-hdr .rule { border-top:2px solid #000; margin:8px 0 0; }
@media screen { body { background:#888; padding:20px 0; } .page { box-shadow:0 2px 16px rgba(0,0,0,.25); } }
</style>
</head><body>
<div class="page">
  <div class="page-hdr">
    <table class="hdr-table" cellpadding="0" cellspacing="0"><tr>
      <td class="logo-td"><img src="${LOGO}" class="logo-img" alt="KCMS"><div class="tag">BRINGING KRISHI AND<br>VIGYAN TOGETHER</div></td>
      <td><div class="company">&nbsp;&nbsp;&nbsp;Krishi Care &amp; Management Services Private Limited</div><div class="addr"><strong>Office Address:</strong> 617, 6th Floor, Hubtown Viva, Western Express Highway, Shankarwadi Jogeshwari (East), Mumbai - 400060.<br>Email: recruitments@krishicare.in &nbsp; Website: www.krishicare.in &nbsp; Tel. - +912268284109</div></td>
    </tr></table>
    <div class="rule"></div>
  </div>
  <div class="page-body">${letterBody}</div>
  <div class="page-ftr"><div class="ftr-rule"></div><p class="ftr-text"><strong>Corporate Office:</strong> H-12, Green Park Extension, New Delhi -110016. Tel: 011-41039506.</p><p class="ftr-cin">CIN: ${COMPANY.cin}</p></div>
</div>
</body></html>`;

  // Return object with separate header/footer for wkhtmltopdf
  return { html: fullHtml, headerHtml, footerHtml };
}
...
exports.sendEmail = async (req, res) => {
  try {
    ...
    const { html: offerHTML, headerHtml: offerHeaderHtml, footerHtml: offerFooterHtml } = buildOfferLetterHTML(ol);
    ...
    try {
      ...
      await new Promise((resolve, reject) => {
        // Write header/footer temp files
      const tmpHeader = path.join(tmpDir, `offer_hdr_${ol.id}.html`);
      const tmpFooter = path.join(tmpDir, `offer_ftr_${ol.id}.html`);
      fs.writeFileSync(tmpHeader, offerHeaderHtml);
      fs.writeFileSync(tmpFooter, offerFooterHtml);
      execFile('wkhtmltopdf', [
          ...
          '--margin-left', '18mm',
          '--margin-right', '18mm',
          '--header-html', tmpHeader,
          '--footer-html', tmpFooter,
          '--header-spacing', '3',
          '--footer-spacing', '3',
          '--print-media-type',
          ...
          try { fs.unlinkSync(tmpHeader); fs.unlinkSync(tmpFooter); } catch(_) {}
