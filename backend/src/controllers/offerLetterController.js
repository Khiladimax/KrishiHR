...
function buildOfferLetterHTML(ol) {
  ...
  // First name only for salutation
  const firstName = ol.candidate_name ? ol.candidate_name.split(' ').filter(w => !['Mr.','Ms.','Mrs.','Dr.'].includes(w))[0] || ol.candidate_name : ol.candidate_name;
...
/* ── FIXED HEADER — position:fixed works in wkhtmltopdf 0.12.6 ── */
#hdr {
  position:fixed;
  top:0; left:0; right:0;
  padding:8px 15mm 0 15mm;
  background:#fff;
  z-index:100;
}
#hdr table { width:100%; border-collapse:collapse; }
#hdr .logo-td { width:88px; vertical-align:middle; padding-right:10px; }
#hdr .logo-img { width:78px; height:78px; object-fit:contain; display:block; }
#hdr .tag { font-size:6.5pt; font-weight:bold; color:#000; line-height:1.3; margin-top:3px; text-align:center; width:78px; }
#hdr .co  { font-size:17pt; font-weight:bold; color:#000; line-height:1.15; margin-bottom:3px; }
#hdr .addr { font-size:9pt; color:#000; line-height:1.5; text-align:center; }
#hdr .rule { border-top:1.5px solid #000; margin-top:6px; }

/* ── FIXED FOOTER ── */
#ftr {
  position:fixed;
  bottom:0; left:0; right:0;
  padding:4px 15mm 8px 15mm;
  background:#fff;
  z-index:100;
}
#ftr .rule { border-top:1px solid #000; margin-bottom:4px; }
#ftr .corp { text-align:center; font-size:9pt; }
#ftr .cin  { text-align:center; font-size:9pt; font-weight:bold; }

/* ── BODY CONTENT (margins create space for fixed header/footer) ── */
#body {
  margin-top:42mm;
  margin-bottom:22mm;
  padding:0 15mm;
...
/* Typography */
.para  { line-height:1.65; text-align:justify; margin-bottom:10px; }
.sec   { font-weight:bold; text-decoration:underline; margin:14px 0 6px; page-break-after:avoid; }
...
ul.rules li { line-height:1.65; margin-bottom:8px; text-align:justify; page-break-inside:avoid; }
.willing { page-break-before:avoid; page-break-inside:avoid; }
.sig-intro { margin:16px 0 8px; line-height:1.7; }
...
/* Annexure */
.ann-title { text-align:center; font-weight:bold; margin:14px 0 12px; }
.ann-meta  { font-weight:bold; line-height:1.9; margin-bottom:14px; }
.sal { width:80%; margin:0 auto 18px; border-collapse:collapse; }
.sal th { border:1px solid #000; padding:6px 10px; text-align:left; font-weight:bold; }
.sal th.c-sr { text-align:center; }
.sal th.c-num { text-align:right; }
.sal td { border:1px solid #000; padding:5px 10px; }
...
.ack-para  { line-height:1.6; margin-bottom:22px; }
.ack-row   { display:flex; justify-content:space-between; margin-bottom:18px; }
.ack-field { width:46%; }
.ack-label { font-weight:normal; }
.ack-line  { display:inline-block; border-bottom:1px solid #000; min-width:155px; }
</style>
</head><body>
...
<div id="hdr">
  <table cellpadding="0" cellspacing="0"><tr>
    ...
    <td>
      <div class="co">Krishi Care &amp; Management Services Private Limited</div>
...
<p class="salut">Dear ${firstName},</p>
...
<div class="ack-row">
  <div class="ack-field"><span class="ack-label">Signature: </span><span class="ack-line">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></div>
  <div class="ack-field"><span class="ack-label">Date: </span><span class="ack-line">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></div>
</div>
<div class="ack-row">
  <div class="ack-field"><span class="ack-label">Name: </span><span class="ack-line">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></div>
  <div class="ack-field"><span class="ack-label">Location: </span><span class="ack-line">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></div>
</div>

</div><!-- end #body -->
</body></html>`;

  // Both preview and PDF use same HTML — position:fixed works in wkhtmltopdf
