...
function buildOfferLetterHTML(ol) {
  ...
  // Header: logo left, company name + address right, NO corporate office line here
  const header = `
<table class="hdr-tbl" cellpadding="0" cellspacing="0">
  ...
  <tr><td class="hdr-contact-td">Email: hr@krishicare.in &nbsp;&nbsp; Website: www.krishicare.in &nbsp;&nbsp; Tel. - +912268284109</td></tr>
</table>
<div class="hdr-rule"></div>`;

  // Footer: corporate office + CIN on every page
  const footer = `
<div class="pg-footer">
...
.pg-body { padding: 6px 32px 6px; flex: 1; }
.page-break { page-break-before: always; }

/* HEADER */
.hdr-tbl { width: 100%; border-collapse: collapse; }
.hdr-logo-td { width: 88px; padding: 8px 10px 8px 0; vertical-align: middle; }
.hdr-logo { width: 82px; height: 82px; object-fit: contain; display: block; }
.hdr-name-td { font-size: 19pt; font-weight: bold; color: #000; vertical-align: bottom; padding-bottom: 3px; }
.hdr-addr-td { font-size: 10pt; color: #000; line-height: 1.5; text-align: center; padding-top: 4px; }
.hdr-contact-td { font-size: 9.5pt; color: #000; text-align: center; padding-top: 3px; padding-bottom: 5px; }
.hdr-rule { border-top: 1.5px solid #000; margin: 4px 0 0; }

/* FOOTER */
.pg-footer { padding: 0 0 10px; }
.ftr-rule { border-top: 1px solid #000; margin: 10px 0 4px; }
.ftr-corp { font-size: 9pt; text-align: center; color: #000; line-height: 1.6; }
.ftr-cin { font-size: 9pt; text-align: center; color: #000; font-weight: bold; }

/* BODY */
.date-line { text-align: right; font-size: 12pt; font-weight: bold; margin: 14px 0 16px; }
.cand-block { margin: 0 0 14px 0; }
.cand-name { font-size: 12pt; font-weight: bold; margin-bottom: 2px; }
.cand-line { font-size: 12pt; line-height: 1.65; }
.salut { font-size: 12pt; margin: 14px 0 14px; }
.subj-line { font-size: 12pt; font-weight: bold; text-align: center; text-decoration: underline; margin: 10px 0 14px; }
.para { font-size: 12pt; line-height: 1.6; text-align: justify; margin-bottom: 10px; }
.sec-hd { font-size: 12pt; font-weight: bold; text-decoration: underline; margin: 14px 0 6px; }
ul.rules { margin: 6px 0 10px 26px; }
ul.rules li { font-size: 12pt; line-height: 1.6; margin-bottom: 8px; text-align: justify; }
.sig-intro { font-size: 12pt; margin: 16px 0 8px; }
.sig-row { display: flex; justify-content: space-between; margin-top: 40px; }
.sig-col { width: 44%; }
.sig-img { height: 48px; max-width: 160px; object-fit: contain; display: block; margin-bottom: 4px; }
.sig-blank { height: 48px; }
.sig-lbl { font-size: 12pt; font-weight: bold; line-height: 1.6; }

/* ANNEXURE */
.ann-title { font-size: 12pt; font-weight: bold; text-align: center; text-decoration: underline; margin: 16px 0 14px; }
.ann-meta { font-size: 12pt; font-weight: bold; line-height: 1.9; margin-bottom: 14px; }
.ann-tbl { width: 85%; margin: 0 auto 16px; border-collapse: collapse; font-size: 11pt; }
.ann-tbl th { border: 1px solid #000; padding: 6px 10px; text-align: left; font-weight: bold; background: #fff; }
.ann-tbl td { border: 1px solid #000; padding: 5px 10px; }
...
.ack-title { font-size: 12pt; font-weight: bold; text-decoration: underline; margin: 18px 0 10px; }
.ack-para { font-size: 12pt; line-height: 1.6; margin-bottom: 22px; }
