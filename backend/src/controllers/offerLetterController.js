...
function buildOfferLetterHTML(ol) {
  ...
  // ─── EXACT SPECS FROM WORD FILE ANALYSIS ───────────────────────────────────
  // Page: A4, margin top=35mm(1.375"), right=7.5mm, bottom=15mm, left=10mm
  // Header: position:fixed top=0
  //   - Logo 19mm tall, left
  //   - "Krishi Care & Management Services Private Limited" Arial 19pt bold
  //   - "Regd. & Head Office:" Arial 11pt bold center
  //   - address Arial 9pt center
  //   - horizontal rule below
  // Footer: position:fixed bottom=0
  //   - "Corporate Office:" Arial 9pt left
  //   - "CIN:" Arial 9pt bold left
  // Body text: Arial MT 10pt, line-height ~1.3x
  // Section headings: Arial 10pt bold underlined (Heading1)
  // Date/name/emp code: Calibri 11pt bold
...
#ftr {
  ...
  background:#fff;
  padding:1mm 7.5mm 3mm 10mm;
  z-index:100;
}
#ftr-rule { border-top:1pt solid #000; margin-bottom:1mm; }
#ftr-corp { font-family:'Arial',sans-serif; font-size:9pt; text-align:center; }
#ftr-cin  { font-family:'Arial',sans-serif; font-size:9pt; font-weight:bold; text-align:center; }

/* ── BODY: margins match Word (top=35mm for header space) ── */
#body {
  margin-top:38mm;
  margin-bottom:18mm;
  padding:0 7.5mm 0 10mm;
}

/* ── TYPOGRAPHY (matching Word file exactly) ── */
.date-line {
...
.sig-col { width:46%; }
.sig-img  { height:12mm; max-width:45mm; object-fit:contain; display:block; margin-bottom:1mm; }
.sig-blank{ height:12mm; }
.sig-lbl  { font-family:'Arial',sans-serif; font-size:10pt; font-weight:bold; }
.sig-sub  { font-family:'Arial',sans-serif; font-size:10pt; }
...
/* Table: exact single black border sz=4, all rows bold per Word analysis */
.sal {
  width:82%;
  margin:0 auto 4mm;
  border-collapse:collapse;
...
.sal .c-sr  { text-align:center; width:10%; }
.sal .c-num { text-align:right; width:16%; }

/* Acknowledgement */
.ack-title { font-family:'Arial',sans-serif; font-size:10pt; font-weight:bold; text-decoration:underline; margin:4mm 0 2mm; }
.ack-para  { font-family:'Arial MT','Arial',sans-serif; font-size:10pt; margin-bottom:5mm; }
.ack-row   { display:flex; justify-content:space-between; margin-bottom:5mm; font-family:'Arial MT','Arial',sans-serif; font-size:10pt; }
.ack-field { width:46%; }
.ack-line  { display:inline-block; border-bottom:0.5pt solid #000; min-width:35mm; }
...
<div id="hdr">
  <div id="hdr-inner">
    <div id="hdr-logo">
      <img src="${LOGO}" alt="KCMS">
    </div>
    <div id="hdr-text">
      <div id="hdr-company">Krishi Care &amp; Management Services Private Limited</div>
      <div id="hdr-regd"><strong>Regd. &amp; Head Office:</strong> 617, 6th Floor, Hubtown Viva, Western Express Highway, Shankarwadi,</div>
      <div id="hdr-addr">Jogeshwari (East), Mumbai - 400060.<br>Email: recruitments@krishicare.in, Website: www.krishicare.in, Tel. - +912268284109</div>
    </div>
  </div>
  <div id="hdr-rule"></div>
</div>
...
<div id="ftr">
  <div id="ftr-rule"></div>
  <p id="ftr-corp"><strong>Corporate Office:</strong> H-12, Green Park Extension, New Delhi -110016. Tel: 011-41039506.</p>
  <p id="ftr-cin">CIN: ${CIN}</p>
</div>
...
<br>
${ol.employee_code    ? `<p class="cand-detail">Employee Code &ndash; ${ol.employee_code}</p>` : ''}
${ol.candidate_mobile ? `<p class="cand-detail">Mob &ndash; ${ol.candidate_mobile}</p>` : ''}
${ol.candidate_email  ? `<p class="cand-detail">Email &ndash; ${ol.candidate_email}</p>` : ''}
<br>
...
<table class="sal">
  <tr><td class="c-sr">Sr. No.</td><td>Particulars</td><td class="c-num">Monthly</td><td class="c-num">Yearly</td></tr>
  ...
  <tr><td class="c-sr">${conv>0?6:5}</td><td>Gross Pay</td><td class="c-num">${fmtV(gross)}</td><td class="c-num">${fmtV(gross*12)}</td></tr>
  ...
  <tr><td class="c-sr">${conv>0?9:8}</td><td>Total Deduction</td><td class="c-num">${fmtV(totalDed)}</td><td class="c-num">${fmtV(totalDed*12)}</td></tr>
  <tr><td class="c-sr">${conv>0?10:9}</td><td>Net Salary (Gross - Total Deduction)</td><td class="c-num">${fmtV(netSalary)}</td><td class="c-num">${fmtV(netSalary*12)}</td></tr>
  ...
  <tr><td class="c-sr">${conv>0?13:12}</td><td>Total Compensation Package</td><td class="c-num">${fmtV(ctcMonthly)}</td><td class="c-num">${fmtV(ctcAnnual)}</td></tr>
</table>
...
<div class="ack-row">
  <div class="ack-field">Signature: <span class="ack-line">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></div>
  <div class="ack-field">Date: <span class="ack-line">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></div>
</div>
<div class="ack-row">
  <div class="ack-field">Name: <span class="ack-line">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></div>
  <div class="ack-field">Location: <span class="ack-line">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></div>
</div>
