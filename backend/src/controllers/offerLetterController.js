...
function buildOfferLetterHTML(ol) {
  ...
  // ── Each page is a .page div with header, content, footer ─────────────────
  // Content flows naturally within each page. Pages are explicitly defined.
  // Page 1: letter intro + sections 1-4 + other rules start
  // Page 2: other rules continued + acceptance + signatures
  // Page 3: Annexure I
  const mainLetter = `
<div class="page">
  ${hdrHTML}
...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* ── Each .page is one A4 page — has header, content, footer ── */
  .page {
    width: 210mm;
    min-height: 297mm;
    margin: 8mm auto;
  ...
  ul.rules li { font-size: 11pt; line-height: 1.75; margin-bottom: 8px; text-align: justify; }
  ...
  /* ── Annexure ── */
  .ann-title { font-family: Arial, Helvetica, sans-serif; font-size: 11pt; font-weight: bold; text-align: center; margin: 14px 0 10px; }
  ...
  .ann-tbl th { font-family: Arial, sans-serif; font-size: 10.5pt; font-weight: bold; padding: 7px 10px; text-align: center; border: 1px solid #375623; color: #fff; }
