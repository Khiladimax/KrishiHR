...
function buildOfferLetterHTML(ol) {
  ...
  <div class="page-hdr">
    <table class="hdr-tbl" cellpadding="0" cellspacing="0">
      <tr>
        <td class="hdr-logo" rowspan="2" style="width:76px;padding-right:10px;vertical-align:middle;">
      ...
      <tr>
        <td class="hdr-sub">
          <strong>Regd. &amp; Head Office:</strong> 617, 6th Floor, Hubtown Viva, Western Express Highway, Shankarwadi, Jogeshwari (East), Mumbai - 400060.<br>
          Email: administrator@krishicare.in, Website: http://www.krishicare.com, Tel. - +91 22 68284109
        </td>
      </tr>
    </table>
  ...
  // ── PAGE 1: Letter intro through first 3 bullets ───────────────────────────
  const mainLetter = `
<div class="page">
  ${hdrHTML}
  <div class="page-body">
    ...
    <div class="cand-meta">
      ...
      ${ol.candidate_email  ? `<p>Email &ndash; <span class="elink">${ol.candidate_email}</span></p>` : ''}
    </div>
...
<!-- PAGE 2: Remaining bullets + acceptance + signatures -->
<div class="page">
  ${hdrHTML}
  <div class="page-body">
    <ul class="rules" style="margin-top:0;">
      <li>information or the relevant facts, the services can be terminated from the company without giving any reason and any time for notice of termination of services. The company may regularize your services subject to satisfactory completion of period.</li>
...
<div class="page">
  ...
  <div class="page-body">
    ...
    <div class="ack-box">
      ...
      <div class="ack-row">
        <div class="ack-item"><span class="ack-lbl">Signature:</span><div class="ack-line"></div></div>
        <div class="ack-item"><span class="ack-lbl">Date:</span><div class="ack-line"></div></div>
      </div>
      <div class="ack-row">
        <div class="ack-item"><span class="ack-lbl">Name:</span><div class="ack-line"></div></div>
        <div class="ack-item"><span class="ack-lbl">Location:</span><div class="ack-line"></div></div>
      </div>
    </div>
  </div>
  ${ftrHTML}
...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* ── HEADER — full bleed, content indented ── */
  .page-hdr {
    flex-shrink: 0;
    padding: 8px 18mm 0 18mm;
  }
  .hdr-tbl  { width: 100%; border-collapse: collapse; }
  .hdr-logo { width: 76px; padding-right: 10px; vertical-align: middle; }
  .logo-img { width: 70px; height: 70px; display: block; }
  .hdr-name {
    font-family: Arial, Helvetica, sans-serif;
    font-size: 16pt; font-weight: 900; color: #1a6b1a;
    vertical-align: middle; line-height: 1.1;
  }
  .hdr-sub  { font-family: Arial, sans-serif; font-size: 8pt; color: #111; text-align: center; line-height: 1.55; padding-top: 2px; }
  .hdr-rule { border-bottom: 2px solid #1a6b1a; margin-top: 5px; }
  .hdr-gap  { height: 1.8em; }

  /* ── CONTENT ── */
  .page-body { flex: 1; padding: 0 18mm; }

  /* ── FOOTER — full bleed, always at bottom ── */
  .page-ftr {
    flex-shrink: 0;
    margin-top: auto;
    padding: 0 18mm 8px 18mm;
  }
  .ftr-rule { border-top: 1px solid #555; margin-bottom: 3px; }
  .ftr-corp { font-family: Arial, sans-serif; font-size: 7.5pt; font-weight: bold; text-align: center; color: #111; line-height: 1.6; }
  .ftr-cin  { font-family: Arial, sans-serif; font-size: 7.5pt; font-weight: bold; text-align: center; color: #111; }

  /* ── CONTENT STYLES ── */
  .date-line  { text-align: right; font-size: 11pt; margin-bottom: 12px; font-weight: bold; }
  ...
  .cand-meta p { font-size: 11pt; font-weight: bold; line-height: 1.65; }
  .elink      { color: #000; text-decoration: none; }
  .salut      { font-size: 11pt; margin: 8px 0 12px; }
  .subj-line  { font-size: 11pt; text-align: center; margin: 0 0 14px; font-weight: bold; text-decoration: underline; }
  .para       { font-size: 11pt; line-height: 1.65; text-align: justify; margin-bottom: 10px; }
  .accept-bold { font-weight: bold; }
  .sec-hd {
    font-family: Arial, Helvetica, sans-serif;
    font-size: 11pt; font-weight: bold; text-decoration: underline;
    margin: 12px 0 4px; color: #000;
  }
  ul.rules { margin: 4px 0 10px 18px; padding: 0; list-style: disc; }
  ul.rules li { font-size: 11pt; line-height: 1.65; margin-bottom: 6px; text-align: justify; }

  .sig-section { margin-top: 18px; }
  .sig-from    { font-size: 11pt; margin-bottom: 3px; line-height: 1.6; }
  .sig-row     { display: flex; justify-content: space-between; margin-top: 40px; }
  .sig-col     { width: 44%; }
  .sig-img     { height: 44px; max-width: 180px; display: block; margin-bottom: 2px; }
  .sig-blank   { height: 44px; }
  .sig-lbl     { font-family: Arial, sans-serif; font-size: 11pt; line-height: 1.6; }

  /* ── ANNEXURE ── */
  .ann-title { font-size: 11pt; font-weight: bold; text-align: center; margin: 12px 0 14px; font-family: Arial, sans-serif; }
  .ann-meta  { margin-bottom: 14px; }
  .ann-meta p { font-size: 11pt; font-weight: bold; line-height: 1.7; }
  .ann-ctc   { font-size: 11pt; font-weight: bold; margin-bottom: 10px; font-family: Arial, sans-serif; text-decoration: underline; }
  ...
  .ann-tbl th {
    ...
    padding: 8px 10px; text-align: center; border: 1px solid #000; background: #fff;
  }
  .ann-tbl th.c-part { text-align: center; }
  .ann-tbl td { border: 1px solid #000; padding: 6px 10px; font-size: 10.5pt; }
  .ann-tbl tbody tr { background: #fff; }
  .c-sr  { text-align: center; width: 52px; }
  .c-num { text-align: center; width: 100px; }

  /* Bold rows: Gross Pay(5), Total Deduction(8), Net Salary(9), Total CTC(12) */
  .r-bold td { font-weight: bold; font-family: Arial, sans-serif; }

  .ack-box   { margin-top: 20px; }
  .ack-title { font-size: 11pt; font-weight: bold; text-decoration: underline; margin-bottom: 8px; font-family: Arial, sans-serif; }
  .ack-para  { font-size: 11pt; line-height: 1.65; margin-bottom: 24px; }
  .ack-row   { display: flex; justify-content: space-between; margin-bottom: 20px; }
  .ack-item  { display: flex; align-items: flex-end; gap: 8px; width: 45%; }
  .ack-lbl   { font-size: 11pt; white-space: nowrap; font-family: Arial, sans-serif; }
  .ack-line  { flex: 1; border-bottom: 1px solid #000; min-width: 80px; }

  @media print {
    body { margin: 0; background: #fff; }
    .page { width: 100%; min-height: 297mm; margin: 0; box-shadow: none; page-break-after: always; }
