/**
 * KrishiHR — Master Migration (migrate_all.js)
...
async function runAllMigrations() {
  ...
  try {
    console.log('🚀 Starting KrishiHR master migration...\n');
    ...
    // Set field/offsite MIS employees to all_working (every Saturday is a working day)
    await client.query(`
      UPDATE employees
      SET saturday_policy = 'all_working'
      WHERE saturday_policy IS DISTINCT FROM 'all_working'
        AND employee_code IN (
          'KC016','KC1660','KC2419','KC2561','KC346','KC3643',
          'KC4141','KC4232','KC4426','KC5144','KC5255','KC5949',
          'KC6103','KC6139','KC6447','KC6617','KC6780','KC6980',
          'KC7576','KC7710','KC7726','KC8977','KC8979','KC8986',
          'KC8998','KC9005','KC9006','KC9076','KC9082'
        )
    `);

    // ═══════════════════════════════════════════════════════════════
    // PART 3: GK DAILY SYSTEM
    // ═══════════════════════════════════════════════════════════════
    console.log('📦 Part 3: GK Daily system...');
